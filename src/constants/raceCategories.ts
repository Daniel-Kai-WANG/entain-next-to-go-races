...
export const RACE_CATEGORY_OPTIONS: Array<{
...
}> = [
  {
    ...
    badgeClass:
      'bg-app-light-paletteOldRose/54 text-app-light-paletteOldRose dark:bg-app-light-paletteOldRose/24 dark:text-app-light-paletteOldRose',
    iconClass:
      'bg-app-light-paletteOldRose/30 text-app-light-paletteOldRose dark:bg-app-light-paletteOldRose/22 dark:text-app-light-paletteOldRose',
  },
  {
    ...
    shortLabel: 'Harness',
    badgeClass:
      'bg-app-light-palettePeriwinkle/38 text-app-light-primaryStrong dark:bg-app-light-palettePeriwinkle/24 dark:text-app-light-palettePeriwinkle',
    iconClass:
      'bg-app-light-primaryStrong/30 text-app-light-primaryStrong dark:bg-app-light-palettePeriwinkle/24 dark:text-app-light-palettePeriwinkle',
  },
  {
    ...
    shortLabel: 'Horse',
    badgeClass:
      'bg-app-light-palettePinkOrchid/34 text-app-light-palettePinkOrchid dark:bg-app-light-palettePinkOrchid/22 dark:text-app-light-palettePinkOrchid',
    iconClass:
      'bg-app-light-palettePinkOrchid/30 text-app-light-palettePinkOrchid dark:bg-app-light-palettePinkOrchid/22 dark:text-app-light-palettePinkOrchid',
  },
]

export const ALL_CATEGORY_IDS = [...RACE_CATEGORY_IDS]
